...
const MAIN_DIR = path.join(__dirname, "../../Access/Sector_logo");
const SUB_DIR = path.join(__dirname, "../../Access/Sector_banner");
...
const Company_infoPR_upload = multer({
  storage,
  fileFilter,
  limits: { fileSize: 10 * 1024 * 1024 },
});

export default Company_infoPR_upload;
